...
export class AdminManagementComponent implements OnInit {
  ...
  displayedColumns: string[] = [
    'username', 'email', 'role', 'institution', 'status', 'actions'
  ];
  ...
  searchQuery = '';
  selectedRole = '';
  selectedStatus: boolean | null = null; // CORRIGÉ: type correct
  pageSize = 20;
  currentPage = 0;
  ...
  loadAdmins(): void {
    ...
    const params = {
      ...
      is_active: this.selectedStatus ?? undefined // CORRIGÉ: conversion null -> undefined
    };
