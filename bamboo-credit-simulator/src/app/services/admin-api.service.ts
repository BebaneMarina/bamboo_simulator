...
export class AdminApiService {
  ...
  getDashboardStats(): Observable<DashboardStats> {
    return this.http.get<DashboardStats>(`${this.baseUrl}/api/admin/dashboard/stats`)
      .pipe(catchError(this.handleError));
  }

  getRecentActivity(limit = 50): Observable<AuditLog[]> {
    const params = new HttpParams().set('limit', limit.toString());
    return this.http.get<AuditLog[]>(`${this.baseUrl}/api/admin/dashboard/recent-activity`, { params })
      .pipe(catchError(this.handleError));
  }

  getPerformanceMetrics(days = 30): Observable<any> {
    const params = new HttpParams().set('days', days.toString());
    return this.http.get<any>(`${this.baseUrl}/api/admin/dashboard/performance-metrics`, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  getInsuranceCompanies(params?: any): Observable<PaginatedResponse<InsuranceCompany>> {
    ...
    return this.http.get<PaginatedResponse<InsuranceCompany>>(`${this.baseUrl}/admin/insurance-companies`, { params: httpParams })
      .pipe(catchError(this.handleError));
  }

  getInsuranceCompany(id: string): Observable<InsuranceCompany> {
    return this.http.get<InsuranceCompany>(`${this.baseUrl}/admin/insurance-companies/${id}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getCreditApplications(params?: any): Observable<PaginatedResponse<CreditApplication>> {
    ...
    return this.http.get<PaginatedResponse<CreditApplication>>(`${this.baseUrl}/api/admin/applications/credit`, { params: httpParams })
      .pipe(catchError(this.handleError));
  }

  updateCreditApplication(id: string, update: any): Observable<CreditApplication> {
    return this.http.put<CreditApplication>(`${this.baseUrl}/api/admin/applications/credit/${id}`, update)
      .pipe(catchError(this.handleError));
  }
  ...
  getAuditLogs(params?: any): Observable<PaginatedResponse<AuditLog>> {
    ...
    return this.http.get<PaginatedResponse<AuditLog>>(`${this.baseUrl}/admin/audit`, { params: httpParams })
      .pipe(catchError(this.handleError));
  }
  ...
  uploadFile(file: File, type: string): Observable<{ file_url: string }> {
    ...
    return this.http.post<{ file_url: string }>(`${this.baseUrl}/admin/upload`, formData)
      .pipe(catchError(this.handleError));
  }
  ...
  exportData(entity: string, format: 'csv' | 'xlsx' = 'xlsx'): Observable<Blob> {
    ...
    return this.http.get(`${this.baseUrl}/admin/export/${entity}`, {
      params,
      responseType: 'blob'
    }).pipe(catchError(this.handleError));
  }
