        ...
        <div class="charts-section">
          ...
          <div class="chart-container">
            <div class="chart-header">
              <h3>Évolution des Simulations</h3>
              <div class="chart-actions">
                <button class="chart-filter" 
                        [class.active]="selectedFilter === '7d'"
                        (click)="changeSimulationsFilter('7d')">7j</button>
                <button class="chart-filter" 
                        [class.active]="selectedFilter === '1m'"
                        (click)="changeSimulationsFilter('1m')">1m</button>
                <button class="chart-filter" 
                        [class.active]="selectedFilter === '3m'"
                        (click)="changeSimulationsFilter('3m')">3m</button>
                <button class="chart-filter" 
                        [class.active]="selectedFilter === '1y'"
                        (click)="changeSimulationsFilter('1y')">1an</button>
              </div>
            </div>
            <div class="chart-content">
              <canvas #simulationsMainChart></canvas>
            </div>
          </div>
        ...
        <div class="side-panel">
          ...
          <div class="recent-activity">
            ...
            <div class="activity-list" *ngIf="recentActivity.length > 0">
              <div *ngFor="let activity of recentActivity.slice(0, 8)" class="activity-item">
                <div class="activity-icon" [ngClass]="activity.action.toLowerCase()">
                  <i class="fas" 
                     [class.fa-plus]="activity.action === 'CREATE'"
                     [class.fa-edit]="activity.action === 'UPDATE'"
                     [class.fa-trash]="activity.action === 'DELETE'"
                     [class.fa-sign-in-alt]="activity.action === 'LOGIN'"></i>
                </div>
                <div class="activity-content">
                  <div class="activity-text">
                    ...
                    <span *ngIf="activity.entity_id">({{ activity.entity_id }})</span>
                  </div>
...
export class DashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  loadDashboardData(): void {
    ...
    Promise.all([
      this.adminApi.getDashboardStats().toPromise(),
      this.adminApi.getRecentActivity(20).toPromise()
    ]).then(([stats, activity]) => {
