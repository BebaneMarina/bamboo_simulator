    ...
    <div class="simulator-home-container">
          ...
          <div class="assur-content">
            <div class="assur-info">
              ...
              <p class="assur-description">
                Notre filiale d'assurance vous accompagne dans tous vos projets avec des solutions 
                d'assurance adaptées aux réalités gabonaises.
              </p>
              <div class="assur-products">
                <div class="product-item">
                  <div class="product-icon" [innerHTML]="assuranceProductsIcons['auto']"></div>
      ...
      <section class="cta-section">
        <div class="container">
          ...
          <div class="cta-buttons">
            <button (click)="navigateToService('/borrowing-capacity')" class="btn-white">
