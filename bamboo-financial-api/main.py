...
def authenticate_admin(username: str, password: str):
    """
    Authentifie un admin - version simplifiée avec plusieurs comptes de test
    """
...
try:
    ...
    print("Warning: admin_management router not available")
...
if admin_management_available:
    app.include_router(admin_management.router, prefix="/api/admin/management", tags=["Admin - Gestion"])
...
async def root():
    ...
    if admin_management_available:
        available_routes.append("admin_management")
    if admin_dashboard_available:
    ...
    return {
        ...
        "admin_routes": {
            ...
            "admin_management": "/api/admin/management/admins" if admin_management_available else "not_available",
            "admin_stats": "/api/admin/management/stats" if admin_management_available else "not_available",
...
async def get_version():
    ...
    return {
        ...
        "available_modules": {
            ...
            "auth": True,  # Maintenant intégré
            "admin_auth": True,
            "admin_management": admin_management_available
        },
        "endpoints": {
            "public": {
                "banks": "/api/banks" if banks_available else "not_available",
            ...
            "admin": {
                ...
                "banks": "/api/admin/banks" if bank_admin_available else "not_available",
                "banks_stats": "/api/admin/banks/stats" if bank_admin_available else "not_available",
                "admins_list": "/api/admin/management/admins" if admin_management_available else "not_available",
                "admins_create": "/api/admin/management/admins" if admin_management_available else "not_available",
                "admins_stats": "/api/admin/management/stats" if admin_management_available else "not_available",
                "institutions": "/api/admin/management/institutions" if admin_management_available else "not_available"
            }
        }
    }
